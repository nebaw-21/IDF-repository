      ...
      <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-6 pb-10 sm:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center min-h-[80vh] pt-10 sm:pt-20">
          ...
          <div ref={contentRef} className="text-center lg:text-left order-2 lg:order-1 px-2 sm:px-0 animate-slide-up">
            {/* Company Badge */}
            <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-[#5BC0F8]/20 border border-[#5BC0F8]/30 rounded-full text-[#5BC0F8] text-xs sm:text-sm font-medium mb-3 sm:mb-6 backdrop-blur-sm poppins-medium animate-fade-in-delay">
              <span className="w-2 h-2 bg-[#FFA500] rounded-full mr-2 animate-pulse"></span>
              Innovating for a Better Tomorrow
            </div>

            {/* Main Headline */}
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-3 sm:mb-6 leading-tight poppins-bold animate-slide-up-delay">
              <span className="block">We are building</span>
              <span className="block text-[#5BC0F8]">a better tomorrow</span>
            </h1>

            {/* Key Features */}
            <div className="mb-5 sm:mb-8 animate-slide-up-delay-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-3 gap-2 sm:gap-4">
                ...
                <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg backdrop-blur-sm border border-[#5BC0F8]/20 hover:bg-white/10 transition-all duration-300 sm:col-span-2 lg:col-span-1 animate-fade-in-delay-5">
                  <div className="w-8 sm:w-10 h-8 sm:h-10 bg-[#5BC0F8] rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-white font-bold text-sm sm:text-base poppins-bold">🏆</span>
                  </div>
                  <div className="min-w-0">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mb-6 sm:mb-12 animate-slide-up-delay-3">
