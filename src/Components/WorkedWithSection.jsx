...
export default function WorkedWithSection() {
  const [partnerLogos] = useState(partnersData.partnerLogos);
  ...
  return (
    ...
    >
      ...
      <div
        ref={headerRef}
        className="text-center mb-12 sm:mb-16 animate-slide-up"
      >
      ...
      <div
        ref={carouselRef}
        className="relative w-full overflow-hidden py-8 animate-slide-up-delay"
      >
        <div className="flex animate-scroll-left-to-right whitespace-nowrap">
          {partnerLogos.map((logo, index) => (
            <div
              key={index}
              className={`flex-shrink-0 mx-8 sm:mx-12 md:mx-16 lg:mx-20 animate-fade-in-delay-${
                index + 1
              }`}
            >
              <img
